...
$(function () {
    // setup garden
	$loveCake = $("#loveCake");
	var offsetX = $loveCake.width() / 2;
	var offsetY = $loveCake.height() / 2 - 55;
    $garden = $("#garden");
    gardenCanvas = $garden[0];
		gardenCanvas.width = $("#loveCake").width();
    gardenCanvas.height = $("#loveCake").height()
    gardenCtx = gardenCanvas.getContext("2d");
    gardenCtx.globalCompositeOperation = "lighter";
    garden = new Garden(gardenCtx, gardenCanvas);
	
	$("#content").css("width", $loveCake.width() + $("#code").width());
	$("#content").css("height", Math.max($loveCake.height(), $("#code").height()));
